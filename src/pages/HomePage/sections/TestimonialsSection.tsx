...
const testimonials = [
  ...
  },
  {
    ...
    quote: 'As a content creator, VoiceBox has been game-changing for our international dubbing. We've cut production costs by 70% while maintaining authentic voice quality across 45 markets. Our audiences can't tell the difference from traditional voice actors.',
    rating: 5,
    delay: 0.2
  },
  {
    ...
    quote: 'Patient communication is crucial in healthcare. VoiceBox helps our physicians explain complex medical concepts in the patient's native language with appropriate emotional tone. We've seen a 40% improvement in treatment adherence due to better understanding.',
    rating: 4,
    delay: 0.3
  },
  {
